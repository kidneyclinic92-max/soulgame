export default function JoinDiscordSection() {
  return (
    <section id="join-discord" className="relative py-20 md:py-28 overflow-hidden">
      {/* Dark background – optional: add bg image for characters via public/assets/join-discord-bg.jpg */}
      ...
      <div className="container-custom relative z-10">
        <div className="max-w-2xl mx-auto text-center">
          {/* Discord logo in gradient circle */}
          <div className="inline-flex items-center justify-center w-20 h-20 md:w-24 md:h-24 rounded-full bg-gradient-to-br from-brand-500 via-purple-500 to-cyan-500 p-[3px] mb-8 shadow-lg shadow-brand-500/30">
          ...
          {/* Main heading – purple to blue gradient */}
